<div align="center">
  ...
  <p>
    <a href="https://www.codacy.com/gh/nulls-brawl-site/bsod4ik-heroku/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=nulls-brawl-site/bsod4ik-heroku&amp;utm_campaign=Badge_Grade">
      <img src="https://app.codacy.com/project/badge/Grade/97e3ea868f9344a5aa6e4d874f83db14" alt="Codacy Grade">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/languages/code-size/nulls-brawl-site/bsod4ik-heroku" alt="Code Size">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/issues-raw/nulls-brawl-site/bsod4ik-heroku" alt="Open Issues">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/license/nulls-brawl-site/bsod4ik-heroku" alt="License">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/commit-activity/m/nulls-brawl-site/bsod4ik-heroku" alt="Commit Activity">
    </a>
    <br>
    <a href="#">
      <img src="https://img.shields.io/github/forks/nulls-brawl-site/bsod4ik-heroku?style=flat" alt="Forks">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/stars/nulls-brawl-site/bsod4ik-heroku" alt="Stars">
    </a>
    <a href="https://github.com/psf/black">
      <img src="https://img.shields.io/badge/code%20style-black-000000.svg" alt="Code Style: Black">
    </a>
    <br>
    <a href="https://github.com/nulls-brawl-site/bsod4ik-heroku/blob/master/README.md">
      <img src="https://img.shields.io/badge/lang-en-red.svg" alt="En">
    </a>
    <a href="https://github.com/nulls-brawl-site/bsod4ik-heroku/blob/master/README_RU.md">
...
<details>
  ...
  git clone https://github.com/nulls-brawl-site/bsod4ik-heroku && \
  cd Heroku && \
  python3 -m venv .venv && \
...
```bash
clear && git clone https://github.com/nulls-brawl-site/bsod4ik-heroku && cd Heroku && python3 -m venv .venv && source .venv/bin/activate && pip install -r requirements.txt && python3 -m heroku
```
...
```bash
sudo apt update && sudo apt upgrade -y && sudo apt install python3 git python3-pip -y && git clone https://github.com/nulls-brawl-site/bsod4ik-heroku && cd Heroku && python3 -m venv .venv && source .venv/bin/activate && sudo pip install -r requirements.txt && python3 -m heroku
```
