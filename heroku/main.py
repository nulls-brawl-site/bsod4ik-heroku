        ...
        try:
            ...
            try:
                ...
                await client.heroku_inline.bot.send_photo(
                    log_chat_id,
                    "https://raw.githubusercontent.com/nulls-brawl-site/bsod4ik-assets/refs/heads/main/heroku/heroku_started.png",
                    caption=(
                        "{} <b>{} started!</b>\n\n<tg-emoji emoji-id=5231065262228250587>⚙</tg-emoji> <b>GitHub commit SHA: <a"
                        ' href="https://github.com/nulls-brawl-site/bsod4ik-heroku/commit/{}">{}</a></b>\n<tg-emoji emoji-id=5873225338984599714>🔎</tg-emoji>'
